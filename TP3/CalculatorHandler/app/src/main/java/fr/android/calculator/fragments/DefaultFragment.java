...
import fr.android.calculator.CalculateHandler;
...
public class DefaultFragment extends Fragment {
    ...
    public void onEqualClick(View v) {
        CalculateHandler calculateHandler = new CalculateHandler(getContext(), expression, result, buttonLayout, null);

        Bundle bundle = new Bundle();
        bundle.putString("expression", expression.getText().toString());

        Message message = calculateHandler.obtainMessage();
